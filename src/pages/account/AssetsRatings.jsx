                        ...
                        <div class="swiper swiper-wrapper-r market-swiper line-bt" data-space-between="100" data-preview="auto">
                            <div class="swiper-wrapper menu-tab-v3" role="tablist">
                                ...
                                >
                                    ...
                                    <SwiperSlide>
                                        <div class=" " data-bs-toggle="tab" data-bs-target="#tokenIncrease" role="tab" aria-controls="tokenIncrease" aria-selected="false">
                                            Token Increase |
                                        </div>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <div class=" " data-bs-toggle="tab" data-bs-target="#cryptocurrency" role="tab" aria-controls="cryptocurrency " aria-selected="false">
                                            Discount Cryptocurrency |
                                        </div>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <div class=" " data-bs-toggle="tab" data-bs-target="#newToken" role="tab" aria-controls="newToken" aria-selected="false">
                                            New token |
                                        </div>
                                    </SwiperSlide>
                                    <SwiperSlide>
                                        <div class=" " data-bs-toggle="tab" data-bs-target="#mass" role="tab" aria-controls="mass" aria-selected="false">
                                            Mass
                                        </div>
                                    </SwiperSlide>
                                </Swiper>
